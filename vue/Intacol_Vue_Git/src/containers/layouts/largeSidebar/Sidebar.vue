      ...
      <div>
        <ul class="navigation-left">
          ...
          <li
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'companies' }"
            data-item="companies"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Administrator"></i>
          ...
          <li
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'stables' }"
            data-item="stables"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Administrator"></i>
              <span class="nav-text">Stables</span>
            </a>
            <div class="triangle"></div>
          </li>
          ...
          <li
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'horses' }"
            data-item="horses"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Administrator"></i>
          ...
          <li
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'horsesfeeds' }"
            data-item="horsesfeeds"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Administrator"></i>
              <span class="nav-text">Horses Feeds</span>
            </a>
            <div class="triangle"></div>
          </li>
        </ul>
    ...
    >
      <div ref="sidebarChild">
       ...
       <ul
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/users/userslist">
              <i class="nav-icon i-Checked-User"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/app/users/usersdetail/0">
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">User Add/Edit</span>
            </router-link>
          </li>
        </ul>
        ...
        <ul
          class="childNav d-none"
          data-parent="others"
          :class="{ 'd-block': selectedParentMenu == 'companies' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/companies/companieslist">
              <i class="nav-icon i-Checked-User"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/app/companies/companiesdetail/0">
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">Company Add/Edit</span>
            </router-link>
          </li>
        </ul>
        ...
        <ul
          class="childNav d-none"
          data-parent="others"
          :class="{ 'd-block': selectedParentMenu == 'stables' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/stables/stableslist">
              <i class="nav-icon i-Checked-User"></i>
              <span class="item-name">Stables</span>
            </router-link>
          </li>

          <li class="nav-item">
            <router-link tag="a" class to="/app/stables/stablesdetail/0">
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">Stable Add/Edit</span>
            </router-link>
          </li>
        </ul>
        ...
        <ul
          class="childNav d-none"
          data-parent="others"
          :class="{ 'd-block': selectedParentMenu == 'horses' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/horses/horseslist">
              <i class="nav-icon i-Checked-User"></i>
              <span class="item-name">Horses</span>
            </router-link>
          </li>

          <li class="nav-item">
            <router-link tag="a" class to="/app/horses/horsesdetail/0">
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">Horse Add/Edit</span>
            </router-link>
          </li>
        </ul>
        ...
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/products/productslist">
              <i class="nav-icon i-Checked-User"></i>
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/app/products/productdetail/0">
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">Product Add/Edit</span>
            </router-link>
          </li>
        </ul>
        ...
        <ul
          class="childNav d-none"
          data-parent="others"
          :class="{ 'd-block': selectedParentMenu == 'horsesfeeds' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/horsesfeeds/horsesfeedslist">
              <i class="nav-icon i-Checked-User"></i>
              <span class="item-name">Horses Feeds</span>
            </router-link>
          </li>
          ...
          <li class="nav-item">
            <router-link
              tag="a"
              class
              to="/app/horsesfeeds/horsesfeedsdetail/0"
            >
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">Horses Feeds Add/Edit</span>
            </router-link>
          </li>
        </ul>
      </div>

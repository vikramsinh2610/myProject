    ...
    >
      <div ref="sidebarChild">
        ...
        >
          ...
          <ul class="childNav" data-parent="companies">
            <li class="nav-item">
        ...
        >
          ...
          <ul class="childNav" data-parent="stables">
            <li class="nav-item">
        ...
        >
          ...
          <ul class="childNav" data-parent="horses">
            <li class="nav-item">
        ...
        >
          ...
          <ul class="childNav" data-parent="horsesfeeds">
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              >
                <i class="nav-icon i-Add-User"></i>
                <span class="item-name">Horse Feed Add/Edit</span>
              </router-link>
            </li>
          </ul>
        </div>

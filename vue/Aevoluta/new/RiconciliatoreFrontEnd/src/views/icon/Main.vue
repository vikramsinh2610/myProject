<template>
  ...
  <div class="intro-y grid grid-cols-12 sm:gap-6 gap-y-6 box px-5 py-8 mt-5">
    ...
    <div class="col-span-6 sm:col-span-3 lg:col-span-2 xl:col-span-1">
      <FileXIcon class="block mx-auto" />
      <div class="text-center text-xs mt-2">FileXIcon</div>
    </div>
    <div class="col-span-6 sm:col-span-3 lg:col-span-2 xl:col-span-1">
    ...
    <div class="col-span-6 sm:col-span-3 lg:col-span-2 xl:col-span-1">
      <NotebookIcon class="block mx-auto" />
      <div class="text-center text-xs mt-2">NotebookIcon</div>
    </div>
    <div class="col-span-6 sm:col-span-3 lg:col-span-2 xl:col-span-1">

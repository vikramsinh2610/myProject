            ...
            <div class="box grid grid-cols-12">
              <div class="col-span-12 lg:col-span-4 px-8 py-12 flex flex-col justify-center">
                ...
                <div class="justify-start flex items-center text-slate-600 dark:text-slate-300 mt-12">
                  My Total Assets
                  <AlertCircleIcon class="tooltip w-4 h-4 ml-1.5" title="Total value of your sales: $158.409.416" />
                </div>
                ...
                <TinySlider ref-key="importantNotesRef">
                  <div class="p-5">
                    ...
                    <div class="font-medium flex mt-5">
                      ...
                      <button type="button" class="btn btn-outline-secondary py-1 px-2 ml-auto ml-auto">
                        Dismiss
                      </button>
                    </div>
                  </div>
                  ...
                  <div class="text-slate-500">
                    ...
                    <div class="flex mt-2">
                      <Tippy tag="div" class="w-8 h-8 image-fit mr-1 zoom-in" :content="$f()[0].products[0].name">
                        <img alt="Midone Tailwind HTML Admin Template" class="rounded-md border border-white"
                          :src="$f()[8].images[0]" />
                      </Tippy>

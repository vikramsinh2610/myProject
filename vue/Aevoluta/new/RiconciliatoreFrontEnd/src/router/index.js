...
import AssociatedMatches from "../views/associated-matches/AssociatedMatches.vue";
...
import DocumentiDaValidare from "../views/documenti-da-validare/Main.vue";
import Documenti from "../views/documenti/Main.vue";
...
import MatchAutomaticiValidare from "../views/match-automatici-validare/Main.vue";
import MatchAutomaticiValidareList from "../views/match-automatici-list/Main.vue";
import MatchAutomaticiValidareDetail from "../views/match-automatici-detail/Main.vue";
import MatchValidati from "../views/match-validati/Main.vue";
import Detail from "../views/match-validati-detail/Main.vue";
import MovimentiMatchare from "../views/movimenti-da-matchare/Main.vue";
...
import RagioniSociali from "../views/ragioni-sociali/Main.vue";
const routes = [
  {
    path: "/side-menu",
    component: SideMenu,
    ...
    children: [
      ...
      {
        path: "match-validati",
        name: "side-menu-match",
        component: MatchValidati,
      },
      {
        path: "product-grid",
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "associated-matches",
        name: "top-menu-associated-matches",
        component: AssociatedMatches,
      },
      {
        path: "dashboard-overview-1",
      ...
      {
        path: "documenti-da-validare",
        name: "Documenti da Validare",
        component: DocumentiDaValidare,
      },
      {
        path: "documenti",
        name: "Documenti",
      ...
      {
        path: "ragionisociali",
        name: "Ragioni Sociali",
        component: RagioniSociali,
      },
      {
        path: "categories",
      ...
      {
        path: "match-con-confidenza/elevata",
        name: "Match con Confidenza Elevata",
        component: MatchAutomaticiValidareList,
      },
      {
        path: "match-con-confidenza/intermedia",
        name: "Match con Confidenza Intermedia",
        component: MatchAutomaticiValidareList,
      },
      {
        path: "match-con-confidenza/bassa",
        name: "Match con Confidenza Bassa",
        component: MatchAutomaticiValidareList,
      },
      {
        path: "dettaglio-match/:id",
        name: "Dettaglio Match",
        component: MatchAutomaticiValidareDetail,
      },
      // {
      //   path: "match-automatici-detail/intermedia/:id",
      //   name: "Match con Confidenza Intermedia",
      //   component: MatchAutomaticiValidareDetail,
      // },
      // {
      //   path: "match-automatici-detail/bassa/:id",
      //   name: "Match con Confidenza Bassa",
      //   component: MatchAutomaticiValidareDetail,
      // },
      {
      ...
      {
        path: "match-validati/detail/:id",
        name: "Detail",
        component: Detail,
      },
      {
        path: "movimenti-matchare",
        name: "Movimenti da Associare",
        component: MovimentiMatchare,
      },
      {
        path: "product-list",

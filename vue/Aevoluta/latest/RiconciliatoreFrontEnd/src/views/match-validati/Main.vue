<template>
  ...
  <div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="intro-y col-span-12 w-full filter-block-list">
      <div
        class="col-span-12 xl:col-span-4 left-part bg-white -ml-5 mr-5 rounded-lg"
        v-if="!filterdiv"
      >
          ...
          <div>
            <div class="border border-slate-200/60 rounded mb-2">
              ...
              <select
                ...
                class="form-select w-56 box pr-10"
                :key="filtroMAValuta"
            ...
            <div class="border border-slate-200/60 rounded mb-2">
              <div class="w-56 relative">
                <input
                  type="text"
                  class="form-control w-56 box pr-10 text-slate-700"
          ...
          <tbody>
            <tr v-for="item in items_t" :key="item" class="intro-x">
              ...
              <td class="text-center w-1/8">
                <div
                  class="btn btn-rounded-primary nonclickCursor w-54 mr-1 mb-2"
              ...
              <td class="w-1/8">
                <button
                  id="searchDiv"
                  class="btn mr-2 mb-2"
                  @click="loadDetailPage(item.idmatch)"
                  v-if="!active"
                >
        ...
        >
          ...
          <div class="">
            <select
              ...
              name="onPerPage"
              id="onPerPage"
              @change="onPerPage(perPageRecords)"

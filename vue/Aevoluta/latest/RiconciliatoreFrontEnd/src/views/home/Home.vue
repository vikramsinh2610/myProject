              ...
              <Preview style="display: flex">
                <div class="progress"
                  style="width: 24%;
                                                                                                                                                                  ...
                                                                                                                                                                  text-align: center; ">
                  <di v class="progress-bar h-8" role="progressbar" aria-valuenow="0" aria-valuemin="0"
        ...
        <div class="intro-y box p-5">
          ...
          <div class="w-52 sm:w-auto mx-auto mt-8">
            <div class="flex items-center">
              ...
              <span class="truncate">{{ $t("menu.match_validati") }}</span>
            ...
            <div class="flex items-center mt-6">
              ...
              <span class="truncate">{{
                $t("menu.match_automatici_validare")
              }}</span>
            ...
            <div class="flex items-center mt-4">
              ...
              <span class="truncate">{{ $t("menu.movimenti_matchare") }}</span>
...
function automaticiList(confidence) {
  router.push(`/match-automatici-list?match=${confidence}`);
}

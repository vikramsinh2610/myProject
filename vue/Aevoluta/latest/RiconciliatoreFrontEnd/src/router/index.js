...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "match-automatici-list",
        name: "match-validare-list",
        component: MatchAutomaticiValidareList,
      },
      {
        path: "match-automatici-detail/elevata/:id",
        name: "match-validare-detail/elevata",
        component: MatchAutomaticiValidareDetail,
      },
      {
        path: "match-automatici-detail/intermedia/:id",
        name: "match-validare-detail/intermedia",
        component: MatchAutomaticiValidareDetail,
      },
      {
        path: "match-automatici-detail/bassa/:id",
        name: "match-validare-detail/bassa",
        component: MatchAutomaticiValidareDetail,
      },
      {
        path: "match-validati",

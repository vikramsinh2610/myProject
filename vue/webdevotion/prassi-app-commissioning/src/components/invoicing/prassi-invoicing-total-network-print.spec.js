...
import PrassiInvoicingTotalNetworkPrint from './prassi-invoicing-total-network-print';
...
describe('PrassiInvoicingTotalNetworkList.vue', () => {
  ...
  beforeEach(() => {
    wrapper = mount(PrassiInvoicingTotalNetworkPrint, {
      localVue,
      propsData: {
        closed: false,
        network: [
  ...
  it('renders PrassiInvoicingTotalNetworkPrint component', () => {

      ...
      return [
        {
          ...
          type: 'chip',
          icon: 'fa fa-check',
          chipText: this.$t(`payinChipText.${dossier.type}`),
        },
        {
          _id: '0',
        ...
        },
        {
          _id: '2-0',
          type: 'icon',
          color: dossier.promoterInherited ? 'green' : 'grey',
          icon: dossier.promoterInherited ? 'fas fa-arrow-up' : 'fa fa-check',
          width: 45,
        },
        {
          _id: '3',
          label: dossier.promoterDisplayName,
          sublabel: dossier.promoterDisplayHierarchy,
          sublabelChip: true,
          color: this.$utils.getRoleColor(this.roles, dossier.promoterRoleId),
          size: 'large',
          weight: 'light',
          width: 340,
          type: '2rows',
        ...
        {
          _id: '5',
          label: `${this.$n(dossier.premiumGross / 100, 'nodecimals')}€`,
          sublabel: `${this.$n(dossier.iv / 100, 'nodecimals')}`,
          size: 'medium',
          weight: 'light',
          width: 90,
          type: '2rows',

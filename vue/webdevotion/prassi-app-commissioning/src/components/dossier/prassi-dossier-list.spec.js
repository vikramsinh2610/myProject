...
import PrassiDossierList from './prassi-dossier-list';

const localVue = createLocalVue();
localVue.use(Quasar, { components: All, directives: All, plugins: All });

describe('PrassiDossierList.vue', () => {
  it('renders PrassiDossierList component', () => {
    const wrapper = mount(PrassiDossierList, {
      localVue,
      propsData: {
        proposals: [
          {

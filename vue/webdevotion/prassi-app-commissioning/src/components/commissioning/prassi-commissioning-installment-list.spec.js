...
import PrassiCommissioningInstallmentList from './prassi-commissioning-installment-list';
...
describe('PrassiCommissioningInstallmentList.vue', () => {
  let wrapper;

  beforeEach(() => {
    wrapper = mount(PrassiCommissioningInstallmentList, {
      localVue,
      propsData: {
        closed: false,
        installments: [
  ...
  it('renders PrassiCommissioningInstallmentList component', () => {

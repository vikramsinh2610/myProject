...
describe('PrassiPromoterLetterConditioned.vue', () => {
  let wrapper;

  beforeEach(() => {
    wrapper = shallowMount(PrassiPromoterLetterConditioned, {
      localVue,
      propsData: {
        name: 'Garantito',
        isFetching: false,
  ...
  it('renders PrassiPromoterLetterConditioned component', () => {
  ...
  it('emits changeData when PrassiPromoterLetterConditioned submit clicked', () => {
    const btns = wrapper.findAll({ name: 'PrassiStandardButton' });
    btns.at(0).trigger('click');
  });
});

describe('PrassiPromoterLetterConditioned.vue with broken props', () => {
  let wrapper;
  ...
  it('renders PrassiPromoterLetterConditioned component with broken conditions props', () => {
    const inputs = wrapper.findAll({ name: 'QInput' });
    expect(inputs.length).toEqual(4);
  });
});

describe('PrassiPromoterLetterConditioned.vue with broken conditions props', () => {
  let wrapper;

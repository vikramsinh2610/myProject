...
export default {
    ...
    return {
      myHeader: [
        ...
        },
        {
          ...
          sublabel: 'customerHeader.duplicated',
          size: 'small',
          weight: 'light',
          width: 120,
        },
  ...
  methods: {
    stopScrolling() {
      this.$utils.log('PERSON-LIST', 'STOP SCROLLING');
      this.$refs.infiniteScroll.stop();
    },
    resumeScrolling() {
      this.$utils.log('PERSON-LIST', 'RESUME SCROLLING NEW');
      this.$refs.infiniteScroll.resume();
    },
    forceScrolling() {
      this.$utils.log('PERSON-LIST', 'FORCE SCROLLING');
      this.$refs.infiniteScroll.trigger();
    },
    loadMore(index, done) {
      this.$utils.log('PERSON-LIST', 'loadMore');

...
export default {
  name: 'PrassiCustomerIdentityCardList',
  ...
  methods: {
    ...
    myBody(customer) {
      return [
        ...
        {
          _id: '1',
          label: customer.identityCardType ? customer.identityCardType : '-',
          sublabel: customer.identityCardNumber ? customer.identityCardNumber : '-',
          size: 'small',
          weight: 'normal',
          width: 200,
          type: '2rows',
        ...
        {
          _id: '3',
          label: customer.identityCardIssueDate
            ? this.$d(new Date(customer.identityCardIssueDate))
            : '-',
          sublabel: customer.identityCardExpiryDate
            ? this.$d(new Date(customer.identityCardExpiryDate))
            : '-',
          size: 'small',
          weight: 'normal',
          width: 120,

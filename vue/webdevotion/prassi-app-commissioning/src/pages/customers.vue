      ...
      <q-card style="width: 800px">
        ...
        <q-card-section v-if="customerType === '2'">
          <div class="column justify-between">
            ...
            <q-input
              class="col-6"
              v-model="customerDataCompany.email"
              type="email"
              :label="$t('customer.email')"
              :error="$v.customerDataCompany.email.$error"
              @blur="$v.customerDataCompany.email.$touch"
            />
            <q-input
              class="col-6"
            ...
            <q-select
              ...
              new-value-mode="add-unique"
              use-input
              v-model="customerDataCompany.name"
              :label="$t('customer.name')"
              :options="optionsNamesList"
              @filter="filterNames"
            />
            <q-input
              class="col-6"
              v-model="customerDataCompany.surname"
              type="text"
              :label="$t('customer.surname')"
              :error="$v.customerDataCompany.surname.$error"
              @blur="$v.customerDataCompany.surname.$touch"
            />
          </div>
        </q-card-section>
        <q-card-section>
...
import PrassiCustomerList from '../components/customer/prassi-customer-list';
...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      fetchCustomers: 'dossiers/fetchCustomers',
      ...
      fetchCustomersSummary: 'dossiers/fetchCustomersSummary',
      fetchCustomersSummaryPrevious: 'dossiers/fetchCustomersSummaryPrevious',

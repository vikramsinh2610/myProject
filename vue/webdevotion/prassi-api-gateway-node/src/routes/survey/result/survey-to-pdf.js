  ...
  fastify.get(
    ...
    errorHandler(async (req, reply) => {
      ...
      try {
        ...
        await page.goto(
          `${req.secure ? 'https://' : 'http://'}${req.headers.host}/v1/survey/survey-to-html/${
        ...
        const codeSurveyResult = surveyResult.codeSurveyResult.toLowerCase();
          ...
          .addDocument(
            {
              ...
              ownerId: 'SYSTEM',
              displayName: `${codeSurveyResult}-${name}-${surname}-${translateSurveyTypeId}.pdf`,
              locked: true,
            },
            pdf,
          )

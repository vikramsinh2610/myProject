  ...
  fastify.get(
      ...
      errorHandler(async (req, reply) => {
        ...
        try {
          ...
          await page.goto(
              `${req.secure ? 'https://' : 'http://'}${req.headers.host}/v1/survey/ricevuta-info-sicurezza-to-html/${
              ...
              .addDocument(
                  {
                    ...
                    ownerId: 'SYSTEM',
                    displayName: `ricevuta-info-sicurezza-${name}-${surname}-${translateSurveyTypeId}.pdf`,
                    locked: true,
                  },
                  pdf,
              )

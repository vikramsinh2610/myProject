    ...
    errorHandler(async (request, reply) => {
      ...
      const queryPractices = sql
        ...
        .select(
          ...
          'practice_commission.productivePeriodYear as productivePeriodYear',
        ...
        .join('practice_owner AS po', function () {
          ...
          this.on(
            ...
            sql.raw(
              // eslint-disable-next-line max-len
              '(select uuid from practice_owner where practice_owner."dossierId" = "practice_commission"."dossierId" order by "productivePeriodYear" desc, "productivePeriodMonth" desc limit 1)',
            ),
          );
        })
      ...
      const practices = await queryPractices
        .orderBy('practice_commission.contractId', 'asc')
        .orderBy('practice_commission.installment', 'asc')

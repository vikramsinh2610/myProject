  ...
  fastify.get(
    ...
    errorHandler(async (request, reply) => {
      ...
      const thisPersonPre = await sql
          ...
          .leftJoin('precontractual_person AS p', 'p.id', 'pr.personId')
          .where('pr.id', request.params.precontractualId)
          .then((results) => results[0]);

      const person = await (thisPersonPre && thisPersonPre.id ?
          personRepository.getPersonPrecontractualbyPrecontractualId(sql, request.params.precontractualId) :
          personRepository.getPersonbyPrecontractualId(sql, request.params.precontractualId));

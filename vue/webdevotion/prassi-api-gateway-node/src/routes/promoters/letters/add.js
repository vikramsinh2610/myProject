...
module.exports = (fastify, opts, next) => {
  const options = {
    ...
    schema: {
      summary: 'Promoter Letter Add',
      description: 'Add a letter for promoter',
      tags: ['letters'],
      params: {
        type: 'object',
        properties: {
  ...
  fastify.post('/', options, (request, reply) => {
    ...
    letterService
      .createLetter(request.params.promoterId, request.query.type || types.JOB)
      .then((letter) => reply.send({ _meta: {}, item: letter }))

...
async function getMeta(
  ...
  const currentReminder = edition === 'tcw' && previousOutcomeResult ? currentOutcomeResult.reminder : 0;
...
module.exports = (fastify, opts, next) => {
  const options = {
    ...
    schema: {
      summary: 'Forecast Countability List',
      description: 'Countability forecast list',
      tags: ['countability'],
      querystring: {
        type: 'object',
        required: [
        ...
        properties: {
          ...
          commissionType: {
            type: 'string',
            enum: ['purchase', 'cash-in', 'management-fee', 'advance'],
            ...
            items: {
              ...
              items: {
                ...
                properties: {
                  ...
                  commissionType: {
                    type: 'string',
                    enum: ['purchase', 'additional-income', 'cash-in', 'management-fee', 'advance'],
                    description: '',
                  },
                  amount: {
                    type: 'integer',

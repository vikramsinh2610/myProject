...
export default function Header({ navigation, headerName, wallet, isBackIcon }) {
    ...
    <View style={styles.mainHeader}>
      <View style={styles.topHeader}>
        ...
        <View style={styles.mainheaderBtnLeftBlock}>
          {isBackIcon ? <View style={styles.mainheaderBtn} onTouchStart={() => navigation?.navigate('Company')}>
        ...
        <View style={styles.mainheaderBtnBlock}>
          <View style={styles.mainheaderBtn}>
            <AntDesign name={headerName === "Payment" ? "hearto" : "shoppingcart"} size={28} style={styles.topHeaderIcon}
             onPress={() => navigation?.navigate('Cart')} />
          </View>
          {wallet ? <View style={styles.mainheaderBtn}>
            <Ionicons name="wallet-outline" size={28} style={styles.topHeaderIcon} onPress={() => {
            navigation?.navigate('Wallet')}}/></View> :
            <View />}
        </View>

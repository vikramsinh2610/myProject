                ...
                <View style={styles.contentBlock}>
                    ...
                    <View style={styles.buttonRow}>
                        ...
                        <TouchableOpacity style={styles.favBtn}>
                            <Text style={styles.btnTitle}>רשימת משאלות</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.timeBtn}>
                            <Text style={styles.btnTitle}>הזמינו את התאריך</Text>
                                                   </TouchableOpacity>
                    </View>

                    <View style={styles.buttonRow}>
                        <TouchableOpacity style={styles.cartBtn}>
                            <Text style={styles.btnTitle}>הוסף לעגלה</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.makeBtn}>
                            <Text style={styles.btnTitle}>קוּפּוֹן</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>

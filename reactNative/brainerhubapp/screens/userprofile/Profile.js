...
const Profile = ({ navigation, route }) => {
    ...
    const [isProfileTab, setProfileTab] = useState(false);
    ...
    const renderRatings = () => {
        return <View style={{ flexDirection: 'row' }}>
            ...
            <ProgressBar progress={0.5} color={Colors.red900} style={styles.progressBarStyle} />
        </View>
    }
            ...
            <View style={{ backgroundColor: "#fff" }}>
                ...
                <View style={styles.containerBlock}>
                    ...
                    <View style={styles.productTabs}>
                        {profileTab.map(item => {
                            return <Text style={[styles.productTabsItems, { backgroundColor: isProfileTab ? '#d9d9d9' : "" }]} onPress={() => { setProfileTab(true) }}>{item.name}</Text>

                        })}
                        {/* <Text style={styles.productTabsItems} onPress={()=>console.log("Top Rated")}>Top Rated</Text>
                        <Text style={styles.productTabsItems} onPress={()=>console.log("All")}>All Collection</Text> */}
                    </View>
...
const styles = StyleSheet.create({
    ...
    progressBarStyle: {
        height: 10, width: 150, borderRadius: 20
    }
})
